...
/**
 * <p>A KeyChainGroup is used by the {@link org.curiumj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.curiumj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.curiumj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.curiumj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
