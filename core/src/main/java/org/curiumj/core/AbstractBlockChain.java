 ...
 * the lightweight SPV mode, a {@link org.curiumj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.curiumj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
