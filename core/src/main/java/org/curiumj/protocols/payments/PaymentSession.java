 ...
 *
 * <ul>
 * <li>A {@link CuriumURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a CuriumURI or a url, a network request is made for the payment request object and a
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style CuriumURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final CuriumURI uri) throws PaymentProtocolException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final CuriumURI uri, final boolean verifyPki)
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final CuriumURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in CuriumURI " + uri);
        try {
